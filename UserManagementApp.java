...
public class UserManagementApp extends Application {
	...
	private void articleHomePage(Stage stage)	{
		...
		layout.getChildren().addAll(action,listArticles,createArticle,deleteArticleInput,deleteArticle, editArticles, backup, restore, backupByGroup, backupGroup, restoreByGroup, restoreGroup, search, goBack);
	...
	private void viewArticle(Stage stage, Articles art, Map<String, Articles> searchResult)
	{
		...
		Button goBack = new Button("Go Back");
		String text = String.valueOf(decryptedBody);				//fill decrypted array with 0 to prevent leaks
